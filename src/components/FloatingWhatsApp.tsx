  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex flex-col gap-3 items-end pb-[env(safe-area-inset-bottom,0px)]">
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          aria-label="Kembali ke atas / Scroll to top"
          className="bg-white hover:bg-neutral-100 active:bg-neutral-200 text-neutral-800 border border-neutral-200/85 p-3 rounded-full shadow-lg hover:scale-110 active:scale-95 transition-all duration-300 flex items-center justify-center cursor-pointer min-h-[44px] min-w-[44px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500"
        >
